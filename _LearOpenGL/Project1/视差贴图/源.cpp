...
#pragma endregion
    ...
    unsigned int diffuseTexture = loadTexture("D:/_LearOpenGL/Project1/Texture/bricks2.jpg");
    unsigned int normalMap = loadTexture("D:/_LearOpenGL/Project1/Texture/bricks2_normal.jpg");
    unsigned int depthMap = loadTexture("D:/_LearOpenGL/Project1/Texture/bricks2_disp.jpg");
...
#pragma region 渲染循环
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 model(1);
        model = glm::rotate(model, (float)glfwGetTime(), glm::normalize(glm::vec3(1, 0, 1)));
